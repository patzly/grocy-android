...
Grocy Android is an open-source Android client for grocy. [grocy](https://grocy.info/) ([source](https://github.com/grocy/grocy)) is a self-hosted groceries & household management solution for your home.
