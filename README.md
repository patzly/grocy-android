...
**Version 2.0.0 is finished soon. You can download the latest beta version on the [releases page](https://github.com/patzly/grocy-android/releases/) or on [Google Play](https://play.google.com/store/apps/details?id=xyz.zedler.patrick.grocy).  
