...
public class ShoppingListEditViewModel extends AndroidViewModel {
    ...
    private ArrayList<String> getShoppingListNames(ArrayList<ShoppingList> shoppingLists) {
        ...
        for(ShoppingList sl : shoppingLists) shoppingListNames.add(sl.getName());
    ...
    public void saveShoppingList() {
        ...
        if(startupShoppingList != null) {
            dlHelper.put(
                    ...
                    error -> {
                        showErrorMessage();
                        if(debug) Log.e(TAG, "saveShoppingList: " + error);
                    }
            );
        } else {
            dlHelper.post(
    ...
    public void safeDeleteShoppingList() {
        if(startupShoppingList == null) return;
    ...
    public void deleteShoppingList() {
        ...
        dlHelper.delete(
                ...
                error -> {
                    showErrorMessage();
                    if(debug) Log.i(TAG, "deleteShoppingList: " + error);
                    downloadData();
                }
        );
    }
    ...
    public void resetShoppingListForPreviousFragmentIfNecessary() {
        ...
        if(startupShoppingList.getId() != lastId) return;
