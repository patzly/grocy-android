...
public class ItemTouchHelperExtension extends RecyclerView.ItemDecoration
    ...
    private void getSelectedDxDy(float[] outPosition) {
        ...
        if ((mSelectedFlags & (UP | DOWN)) != 0) {
            ...
            outPosition[1] = mSelected.itemView.getTranslationX();
        }
    }
    ...
    private void select(ViewHolder selected, int actionState) {
        ...
        if (!preventLayout && mRecyclerView.getLayoutManager() != null) {
    ...
    public interface ViewDropHandler {
         ...
         *               {#prepareForDrop(View, View, int, int)} after this one.
    ...
    public abstract static class Callback {
        ...
        static {
            sUICallback = new CustomItemTouchUiUtil();
        }
...
//                mX = ViewCompat.getTranslationX(mViewHolder.itemView);
    ...
    private static class CustomItemTouchUiUtil implements ItemTouchUIUtil {
        @Override
