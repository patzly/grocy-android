...
public class MasterDataBottomSheet extends CustomBottomSheet implements View.OnClickListener {

    private final static String TAG = MasterDataBottomSheet.class.getSimpleName();
