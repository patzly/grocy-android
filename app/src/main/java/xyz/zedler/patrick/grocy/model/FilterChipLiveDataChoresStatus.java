...
public class FilterChipLiveDataChoresStatus extends FilterChipLiveData {
  ...
  public FilterChipLiveDataChoresStatus setDueSoonCount(int dueSoonCount) {
    this.dueSoonCount = dueSoonCount;
    return this;
  }

  public FilterChipLiveDataChoresStatus setOverdueCount(int overdueCount) {
