...
import xyz.zedler.patrick.grocy.databinding.FragmentSettingsCatNotificationsSettingsBinding;
...
public class SettingsCatNotificationsSettingsFragment extends BaseFragment {

  private final static String TAG = SettingsCatNotificationsSettingsFragment.class.getSimpleName();

  private FragmentSettingsCatNotificationsSettingsBinding binding;
  ...
  public View onCreateView(
    ...
    binding = FragmentSettingsCatNotificationsSettingsBinding.inflate(inflater, container, false);
  ...
  public void saveInput(String text, Bundle argsBundle) {
    ...
    if (type != null ){
      if(type.equals(NOTIFICATIONS.NOTIFICATIONS_ENABLE)){
        if(text.equals("true")) // TODO: igor debug
      ...
      /*
      else if(type.equals(NOTIFICATIONS.NOTIFICATIONS_TIME))
        viewModel.setNotificationsTime(text);
      */
    }
  }
