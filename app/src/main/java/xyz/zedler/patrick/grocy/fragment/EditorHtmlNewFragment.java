...
import xyz.zedler.patrick.grocy.databinding.FragmentEditorHtmlNewBinding;

public class EditorHtmlNewFragment extends BaseFragment {

  private final static String TAG = EditorHtmlNewFragment.class.getSimpleName();

  private FragmentEditorHtmlNewBinding binding;
  ...
  public View onCreateView(
    ...
    binding = FragmentEditorHtmlNewBinding.inflate(inflater, container, false);
  ...
  public void onViewCreated(@Nullable View view, @Nullable Bundle savedInstanceState) {
    ...
    Aztec.with(binding.aztecVisual, new SourceViewEditText(requireContext()), binding.aztecToolbar, new IAztecToolbarClickListener() {
      @Override
    ...
    activity.getScrollBehavior().setUpScroll(
        binding.appBar, false, binding.container, true
    );
