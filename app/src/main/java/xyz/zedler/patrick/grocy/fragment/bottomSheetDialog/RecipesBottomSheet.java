...
import xyz.zedler.patrick.grocy.adapter.RecipeAdapter;
...
public class RecipesBottomSheet extends BaseBottomSheetDialogFragment
    implements RecipeAdapter.RecipeAdapterListener {

  private final static String TAG = RecipesBottomSheet.class.getSimpleName();
  ...
  public View onCreateView(
    ...
    ArrayList<Recipe> recipesArg = bundle.getParcelableArrayList(ARGUMENT.RECIPES);
    assert recipesArg != null;
